...
echo -e "${C_B_GRN}▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰${R}"
echo -e "${B}${C_B_YLW}  PROTOCOL COMPLETE. MAINTAINER: DevZeron${R}"
echo -e "${C_D_GRN}  [*] GitHub       : ${C_B_GRN}ZeronModz${R}"
echo -e "${C_D_GRN}  [*] Telegram     : ${C_B_GRN}@DevZeron${R}"
echo -e "${C_D_GRN}  [*] TG Channel   : ${C_B_GRN}@DevZeron${R}"
echo -e "${C_D_GRN}  [*] Website      : ${C_B_GRN}t.me/DevZeron${R}"
echo -e "${C_B_GRN}▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰${R}"
